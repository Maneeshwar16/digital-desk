        ...
        <div className="flex flex-col gap-1 relative">
            ...
            {passwordChecks.map((c, i) => (
              <li
                ...
                className={`flex items-center gap-1 ${
                  password ? (passwordResults[i] ? 'text-green-600' : 'text-red-500') : 'text-gray-400'
                }`}
              >
                <span
                  ...
                  style={{
                    background: password
                      ? (passwordResults[i] ? '#16a34a' : '#ef4444')
                      : '#d1d5db',
                  }}
                ></span>
                {c.label}
          ...
          {password && (
            <div className="mt-2">
              ...
              <span
                className={`text-xs font-medium ml-1 ${strength.color.replace('bg-', 'text-')}`}
              >
                {strength.label}
              </span>
            </div>
